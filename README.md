...
| Sesión 4: [Visualización de Datos](#class-7-getting-data)                      | - Conocer las herramientas y bibliotecas para la visualización de datos en Python (Matplotlib, Seaborn).<br>- Crear gráficos básicos y avanzados para representar datos.                   |
