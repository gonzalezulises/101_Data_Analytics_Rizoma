...
|                                                                                  |                                                                           |
| -------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| Sesión 1: Introducción a Data Analytics [Introducción a Data Analytics](#sesión-1-introducción-a-data-analytics)      | [Funciones y listas en python](#class-2-command-line-and-version-control) |
