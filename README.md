...
| -------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Sesión 1:  [Introducción a Python](#class-1-introduction-to-data-science)        | - Comprender los conceptos fundamentales de la analítica de datos.<br>- Identificar los diferentes tipos de análisis de datos: descriptivo, predictivo y prescriptivo.<br>- Familiarizarse con el flujo de trabajo en un proyecto de analítica de datos.<br>- Conocer las herramientas y tecnologías utilizadas en la analítica de datos.                                            |
| Sesión 2: [Obtención de Datos](#class-3-data-reading-and-cleaning)               | - Aprender a obtener y cargar datos desde diversas fuentes (CSV, Excel, SQL, APIs).<br>- Introducción a la biblioteca Pandas y sus estructuras de datos principales (Series y DataFrames).<br>- Realizar operaciones básicas de manipulación de datos con Pandas.<br>- Limpiar y preparar datos para su análisis.                                                                    |
| Sesión 3: [Análisis exploratorio de Datos I](#class-6-machine-learning)          | - Entender las técnicas de combinación y fusión de datos utilizando Pandas.<br>- Realizar análisis exploratorios de datos (EDA) para descubrir patrones, detectar anomalías y verificar supuestos.<br>- Utilizar técnicas de agrupación y agregación de datos.<br>- Visualizar los resultados del análisis exploratorio para una mejor interpretación.                               |
| Sesión 4: [Visualización de Datos I](#class-7-getting-data)                      | - Comprender la importancia de la visualización de datos en la analítica.<br>- Conocer las herramientas y bibliotecas para la visualización de datos en Python (Matplotlib, Seaborn).<br>- Crear gráficos básicos y avanzados para representar datos.<br>- Interpretar visualizaciones y extraer conclusiones significativas.                                                        |
| Sesión 5: [Evaluación de modelos de pronóstico](#class-9-basic-model-evaluation) | - Introducción a los modelos de pronóstico y su aplicación en la analítica de datos.<br>- Entender los conceptos de regresión lineal y su uso en la predicción.<br>- Evaluar la precisión y efectividad de los modelos de regresión.<br>- Aplicar técnicas de validación y selección de modelos.                                                                                     |
| Sesión 6: [Logistic Regression](#class-11-first-project-presentation)            | - Comprender los principios de la regresión logística y su aplicación en la clasificación.<br>- Conocer los árboles de decisión y su uso en problemas de clasificación y regresión.<br>- Evaluar y optimizar modelos de regresión logística y árboles de decisión.<br>- Interpretar los resultados y realizar ajustes para mejorar el rendimiento del modelo.                        |
| Sesión 7: [Clustering](#class-13-advanced-model-evaluation)                      | - Introducción a las técnicas de clustering (agrupamiento) y su aplicación en la segmentación de datos.<br>- Conocer los algoritmos de clustering más comunes (K-means, DBSCAN, Hierarchical Clustering).<br>- Evaluar la calidad y efectividad de los modelos de clustering.<br>- Aplicar técnicas avanzadas para mejorar la interpretación y uso de los resultados del clustering. |
| Sesión 8: [Uso de Tableau](#class-14-naive-bayes-and-text-data)                  | - Familiarizarse con Tableau como herramienta de visualización de datos.<br>- Aprender a importar y conectar datos en Tableau.<br>- Crear dashboards interactivos y visualizaciones efectivas.<br>- Publicar y compartir tableros de datos con stakeholders para la toma de decisiones basada en datos.                                                                              |
